...
public class Principal {
	...
	public static void main(String[] args) {
         ...
         */
         ...
         int x = 45;						// en binario es : 101101
         int desplIzquierda = x << 5; 		// en binario es : 10110100000
         System.out.println(desplIzquierda);
         
         //Desplazamiento a la derecha >>
         x = 45;								// en binario es : 101101
         int desplDerecha = x >> 3;				// en binario es : 101
         System.out.println(desplDerecha);	
         
         //Operación OR
         int a = 45; 							// en binario es : 101101
         int b = 11;							// en binario es : 1011
         int oO = a|b; 
         System.out.println(oO);				// en binario es : 101111
         
         //Operación AND
         int c = 55; 							// en binario es : 110111
         int d = 56;							// en binario es : 111000
         int yY = c&d; 
         System.out.println(yY);				// en binario es : 110000
	}
